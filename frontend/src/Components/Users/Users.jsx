...
import { close_AddCustomer, open_AddCustomer } from "./Customer/addCustomer";
import { close_Customer_Table } from "./Customer/CustomerTable";
import { open_Customer_Table } from "./Customer/CustomerTable";
    ...
    <div className="sidebar-container d-flex">
      ...
      <div className={`sidebar ${collapsed ? "collapsed" : ""} `}>
        ...
        <nav className="sidebar-links">
          ...
          <div className={`sidebar-list ${navLinkState.rtp ? "selected1" : ""} `}>
            <a onClick={(e) => {
              // setRTP()
              flushSync(() => {
                setFormState(prev => ({
          ...
          <div className={`sidebar-list ${navLinkState.qurey ? "selected1" : ""} `}>
            <a onClick={(e) => {
              setQuery()
              flushSync(() => {
                setFormState(prev => ({
